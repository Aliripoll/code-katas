...
let order = [ { customerName: "Nicolas", total: 100, delivered: true, }, { customerName: "Zulema", total: 120, delivered: false, }, { customerName: "Santiago", total: 300, delivered: true, } ];

function filterOrders(array) {
    return array
    .filter(element => element.total >= 100 && element.delivered === true);
}
