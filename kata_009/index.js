/* KATA 9: Tienes un array de objetos que representan datos de productos con los siguientes atributos:name, price, stock. 
...
let info = [ { name: "Product 1", price: 1000, stock: 10 }, { name: "Product 2", price: 2000, stock: 20 } ];

function addNewAttr(array) {
    let taxesPrice = 19;
    return array
    .map(num =>  {
       num.taxes = num.price * taxesPrice / 100;
       return num;
    })  
}
addNewAttr(info);
